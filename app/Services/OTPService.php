...
class OTPService
{
    ...
    public function sendOTP($phone, $message, $gateway = null)
    {
        ...
        } else if ($enabledSmsGateway == "usmsgh") {
            $authkey ='198|j5Ea29BOc8nRy1z00RXC8fCOmtVqgtUE35X54PBa';
            $sender = 'A-Rafy';

            $response = Http::withToken($authkey)->post('https://webapp.usmsgh.com/api/sms/send',
            [
                'recipient' => $phone,
                'sender_id' => $sender,
                'message' => $message,
