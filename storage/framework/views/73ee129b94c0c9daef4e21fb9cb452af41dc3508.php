...
} elseif ($_instance->childHasBeenRendered('VS26FvF')) {
    $componentId = $_instance->getRenderedChildComponentId('VS26FvF');
    $componentTag = $_instance->getRenderedChildComponentTagName('VS26FvF');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('VS26FvF');
} else {
    $response = \Livewire\Livewire::mount('header.profile');
    $html = $response->html();
    $_instance->logRenderedChild('VS26FvF', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('YZauaX4')) {
    $componentId = $_instance->getRenderedChildComponentId('YZauaX4');
    $componentTag = $_instance->getRenderedChildComponentTagName('YZauaX4');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('YZauaX4');
} else {
    $response = \Livewire\Livewire::mount('header.subscription');
    $html = $response->html();
    $_instance->logRenderedChild('YZauaX4', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
      </div>
...
<?php /**PATH E:\Laravel\ofelia\resources\views/layouts/app.blade.php ENDPATH**/ ?>