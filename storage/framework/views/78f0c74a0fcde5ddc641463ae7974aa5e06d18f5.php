...
} elseif ($_instance->childHasBeenRendered('l1231906298-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l1231906298-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l1231906298-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l1231906298-0');
} else {
    $response = \Livewire\Livewire::mount('tables.user-table', []);
    $html = $response->html();
    $_instance->logRenderedChild('l1231906298-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH E:\Laravel\ofelia\resources\views/livewire/users.blade.php ENDPATH**/ ?>