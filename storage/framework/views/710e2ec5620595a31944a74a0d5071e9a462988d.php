...
} elseif ($_instance->childHasBeenRendered('l316017519-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l316017519-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l316017519-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l316017519-0');
} else {
    $response = \Livewire\Livewire::mount('tables.product-table', []);
    $html = $response->html();
    $_instance->logRenderedChild('l316017519-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('l316017519-1')) {
    $componentId = $_instance->getRenderedChildComponentId('l316017519-1');
    $componentTag = $_instance->getRenderedChildComponentTagName('l316017519-1');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l316017519-1');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('l316017519-1', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('l316017519-2')) {
    $componentId = $_instance->getRenderedChildComponentId('l316017519-2');
    $componentTag = $_instance->getRenderedChildComponentTagName('l316017519-2');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l316017519-2');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('l316017519-2', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('l316017519-3')) {
    $componentId = $_instance->getRenderedChildComponentId('l316017519-3');
    $componentTag = $_instance->getRenderedChildComponentTagName('l316017519-3');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l316017519-3');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('l316017519-3', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('l316017519-4')) {
    $componentId = $_instance->getRenderedChildComponentId('l316017519-4');
    $componentTag = $_instance->getRenderedChildComponentTagName('l316017519-4');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l316017519-4');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('l316017519-4', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('component.autocomplete-input', ['title' => ''.e(__('Vendor')).'','column' => 'name','model' => 'Vendor','emitFunction' => 'autocompleteVendorSelected','initialEmit' => 'preselectedVendorEmit','disable' => ''.e(auth()->user()->hasRole('manager') ?? 'false').''])->html();
} elseif ($_instance->childHasBeenRendered('l316017519-5')) {
    $componentId = $_instance->getRenderedChildComponentId('l316017519-5');
    $componentTag = $_instance->getRenderedChildComponentTagName('l316017519-5');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l316017519-5');
} else {
    $response = \Livewire\Livewire::mount('component.autocomplete-input', ['title' => ''.e(__('Vendor')).'','column' => 'name','model' => 'Vendor','emitFunction' => 'autocompleteVendorSelected','initialEmit' => 'preselectedVendorEmit','disable' => ''.e(auth()->user()->hasRole('manager') ?? 'false').'']);
    $html = $response->html();
    $_instance->logRenderedChild('l316017519-5', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('component.autocomplete-input', ['title' => ''.e(__('Categories')).'','column' => 'name','model' => 'Category','emitFunction' => 'autocompleteCategorySelected','updateQueryClauseName' => 'categoryQueryClasueUpdate','clear' => true,'queryClause' => $categorySearchClause ?? '','onclearCalled' => 'clearAutocompleteFieldsEvent'])->html();
} elseif ($_instance->childHasBeenRendered('l316017519-6')) {
    $componentId = $_instance->getRenderedChildComponentId('l316017519-6');
    $componentTag = $_instance->getRenderedChildComponentTagName('l316017519-6');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l316017519-6');
} else {
    $response = \Livewire\Livewire::mount('component.autocomplete-input', ['title' => ''.e(__('Categories')).'','column' => 'name','model' => 'Category','emitFunction' => 'autocompleteCategorySelected','updateQueryClauseName' => 'categoryQueryClasueUpdate','clear' => true,'queryClause' => $categorySearchClause ?? '','onclearCalled' => 'clearAutocompleteFieldsEvent']);
    $html = $response->html();
    $_instance->logRenderedChild('l316017519-6', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php $component->withAttributes(['title' => ''.e(__('File')).'','text' => '']); ?>
                    <div class="space-y-3">
                        ...
                        <div class="flex items-center p-2 border rounded">
                            ...
                            <a href="<?php echo e($file->link); ?>" target="_blank" class="font-medium hover:underline text-primary-500 hover:text-primary-800 hover:font-bold">
...
<?php /**PATH E:\Laravel\ofelia\resources\views/livewire/products.blade.php ENDPATH**/ ?>