...
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.baseview','data' => ['title' => ''.e(__('Vendor Subscriptions')).'']]); ?>
...
} elseif ($_instance->childHasBeenRendered('l2615213420-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l2615213420-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l2615213420-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l2615213420-0');
} else {
    $response = \Livewire\Livewire::mount('tables.vendor-subscription-table', []);
    $html = $response->html();
    $_instance->logRenderedChild('l2615213420-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php $component->withAttributes(['withForm' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(false)]); ?>
            ...
            <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.details.item','data' => ['title' => ''.e(__('Transaction Code')).'','text' => ''.e($selectedVendorSubscription->code ?? '').'']]); ?>
...
<?php endif; ?>
                <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.details.item','data' => ['title' => ''.e(__('Status')).'','text' => ''.e($selectedVendorSubscription->status ?? '').'']]); ?>
<?php $component->withName('details.item'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
...
<?php endif; ?>
                <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.details.item','data' => ['title' => ''.e(__('Payment Method')).'','text' => ''.e($selectedVendorSubscription->payment_method->name ?? '').'']]); ?>
<?php $component->withName('details.item'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
...
<?php endif; ?>
                ...
                <div class="grid items-center w-full grid-cols-2 space-x-2 text-center">
                    <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.buttons.deactivate','data' => ['title' => ''.e(__('Reject')).'','bgColor' => 'bg-red-500','wireClick' => 'rejectPayment']]); ?>
...
<?php endif; ?>
                    <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.buttons.activate','data' => ['title' => ''.e(__('Approve')).'','bgColor' => 'bg-red-500','wireClick' => 'approvePayment']]); ?>
...
<?php /**PATH E:\Laravel\ofelia\resources\views/livewire/vendor_subscriptions.blade.php ENDPATH**/ ?>